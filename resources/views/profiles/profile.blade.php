						    ...
						    <div class="row  col-lg-8 col-md-8 col-sm-8  m_bottom_30">
								...
								<!-- Formations -->
		                     	<div class="description col-xs-12 m_top_20" >
			                       ...
			                       <p ><h5 class="m_bottom_20 ">Formations</h5></p><!-- <textarea type="text" placeholder="Formation" id="organisation" name="organisation" class="r_corners color_grey w_full fw_light" value="@if( is_object( $formation ) && isset( $formation->organisation ) && ! old('organisation') ){{ $formation->organisation }}@else{{ old('organisation') }}@endif" required></textarea></p> -->
			                       <!-- organisation = cv -->
			                       <div class="col-xs-6">
